...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 44: Daten in R einlesen
# Vorbereitung: Daten-Datei "PLZ_0.CSV" lokal speichern
PLZ.0 = read.csv2(file.choose())
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 45: Zeitreihendiagramme für 1 Merkmal
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 45: Zeitreihendiagramm gemeinsam für Beginn und Ende
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 50: Zeilennummern für Einträge finden
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 50: Einlesen der überarbeiteten Daten
detach(PLZ.0)
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 51: Erstellen der Grafiken mit PLZ.1
# Balkendiagramme
plot(Lieferant)
plot(Kunde)
plot(Review)
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 65: Streudiagramm-Matrix (im Buch: Wechselwirkungs-Diagramm)
require(lattice)
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 77: Matrixplot mit attributiven Merkmalen
PLZ.1.variabel = subset(PLZ.1, select=c(PL,PMa,Abteilungen,Laufzeit))
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 108: Unwichtige Einflüsse ausschließen (1/2)
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 109: Unwichtige Einflüsse ausschließen (2/2)
# Daten PLZ_1.CSV sind eingelesen
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 121: Modell-Qualitäts-Kennzahlen R², R²(prog) und S
...
S.spm
# zeigt Wert von "S.spm" an, hier: 8.533396 = 8,53 Tage

#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 129: Residuendiagramme: Wahrscheinlichkeitsnetze
# lm.2 wurde berechnet
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 129: Residuendiagramme: Anpassungen vs. Residuen und Beobachtungsnr. vs. Residuen
# lm.2 wurde berechnet
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 130: Residuendiagramme: Auffällige Residuen finden
# lm.2 wurde berechnet
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 146: Modell-Qualitäts-Kennzahlen: Test auf Normalverteilung für Residuen
# lm.2 wurde berechnet
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 156: Quantile und Auswahl von Projekten
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 163: Kontur- und Wirkungsflächendiagramme Laufzeit
# lm.2 wurde berechnet
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 174: Koeffizienten des vereinfachten SPMs ausgeben
# lm.2 wurde berechnet

lm.2$coef # zeigt Koeffizienten von lm.2 an

str(PLZ.1) # zeigt Beschreibung der Daten inkl. Stufen von attributiven Einflussgrößen an

#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 182 Prognosen für Laufzeit
# lm.2 wurde berechnet
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 185: Vertrauens- und Prognosebereiche für Laufzeit
# lm.2 wurde berechnet
...
boxplot(Laufzeit.sim ~ Review+Methode+Komplexität, pch=8, col="lightgrey", lty=1, data=MC.daten)

#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 194: 95%-Prognosebereich
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 203: 95%-Streubereich für die Anpassungsgüte R²
#lm.2 wurde berechnet
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 211: 95%-Streubereich für die Anpassungsgüte R²
# lm.2 wurde berechnet
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 239: Finden der Kombinationen mit obere Prognosegrenze > 200 Tage
# lm.2 wurde berechnet
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 240 Einschränkung der Einstellkombinationen auf obere Prognosegrenze < 200 Tage
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 251: Test auf Normalverteilung und Wahrscheinlichkeitsnetz
# Daten PLZ_1.CSV sind eingelesen und mit attach(PLZ_1.CSV) verfügbar gemacht
...
#++++++++++++++++++++++++++++++++++++++++++++++++#
# S. 257: Toleranzgrenze ohne Normalverteilung
# Daten PLZ_1.CSV sind eingelesen
